...
\textbf{Tái lập kết quả:} Toàn bộ mã nguồn, dữ liệu, và hướng dẫn chạy (\texttt{pip install -r requirements.txt \&\& python scripts/train\_v6.py}) được công khai tại: \url{https://github.com/DuongNAD/datathon-2026-submission}. Random seeds cố định: $[42, 123, 777, 2026, 314]$.
